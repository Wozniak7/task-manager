    ...
    <div class="container mt-5">
        ...
        <form action="store.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" id="title" name="title" class="form-control" required placeholder="Ex: Comprar mantimentos">
            </div>

            <div class="mb-3">
                <label for="description" class="form-label">Descrição:</label>
                <textarea id="description" name="description" class="form-control" rows="4" placeholder="Ex: Leite, ovos, pão..."></textarea>
            </div>
